...
#SBATCH --output=./results/exp_disk_sea/run-4/sea_mem_4n_6t_1d_1000f_617m_10i/slurm-%x-%j.out
...
start=`date +%s.%N`
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/exp_disk_sea/run-4/sea_mem_4n_6t_1d_1000f_617m_10i/n0_sea_parallel.sh &
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/exp_disk_sea/run-4/sea_mem_4n_6t_1d_1000f_617m_10i/n1_sea_parallel.sh &
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/exp_disk_sea/run-4/sea_mem_4n_6t_1d_1000f_617m_10i/n2_sea_parallel.sh &
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/exp_disk_sea/run-4/sea_mem_4n_6t_1d_1000f_617m_10i/n3_sea_parallel.sh &
wait
