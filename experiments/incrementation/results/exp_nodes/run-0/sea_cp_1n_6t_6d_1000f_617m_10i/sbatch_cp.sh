...
#SBATCH --account=vhs
#SBATCH --job-name=sea_cp_1n_6t_6d_1000f_617m_10i
#SBATCH --nodes=1
#SBATCH --nodelist=comp02
#SBATCH --output=./results/exp_nodes/run-0/sea_cp_1n_6t_6d_1000f_617m_10i/slurm-%x-%j.out
...
start=`date +%s.%N`
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/exp_nodes/run-0/sea_cp_1n_6t_6d_1000f_617m_10i/n0_sea_parallel.sh &
wait
