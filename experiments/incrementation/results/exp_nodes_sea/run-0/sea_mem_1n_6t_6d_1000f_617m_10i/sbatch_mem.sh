...
#SBATCH --output=./results/exp_nodes_sea/run-0/sea_mem_1n_6t_6d_1000f_617m_10i/slurm-%x-%j.out
...
start=`date +%s.%N`
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/exp_nodes_sea/run-0/sea_mem_1n_6t_6d_1000f_617m_10i/n0_sea_parallel.sh &
wait
