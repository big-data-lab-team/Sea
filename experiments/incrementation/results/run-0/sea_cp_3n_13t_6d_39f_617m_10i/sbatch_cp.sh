...
#SBATCH --nodes=3
#SBATCH --output=./results/run-0/sea_cp_3n_13t_6d_39f_617m_10i/slurm-%x-%j.out
...
start=`date +%s.%N`
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/run-0/sea_cp_3n_13t_6d_39f_617m_10i/n0_sea_parallel.sh &
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/run-0/sea_cp_3n_13t_6d_39f_617m_10i/n1_sea_parallel.sh &
srun -N 1 bash ${SEA_HOME}/bin/sea_launch.sh ./results/run-0/sea_cp_3n_13t_6d_39f_617m_10i/n2_sea_parallel.sh &
wait
