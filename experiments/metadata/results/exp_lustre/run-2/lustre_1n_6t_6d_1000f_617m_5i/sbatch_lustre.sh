...
#SBATCH --nodes=1
#SBATCH --output=./results/exp_lustre/run-2/lustre_1n_6t_6d_1000f_617m_5i/slurm-%x-%j.out
...
start=`date +%s.%N`
srun -N 1 bash ./results/exp_lustre/run-2/lustre_1n_6t_6d_1000f_617m_5i/n0_sea_parallel.sh &
wait
