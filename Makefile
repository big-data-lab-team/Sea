...
test_custom.o: tests/test_custom.cpp passthrough.o sea.o config.o logger.o
	gcc ${debug_opts} -std=c++11 -Wall -fPIC tests/test_custom.cpp passthrough.o sea.o config.o logger.o -o tests/test_custom -lstdc++ -liniparser -ldl -lgtest -lgmock -lgtest_main -lpthread 
test: test_custom.o
clean:
