...
typedef int (*funcptr_mkdirat)(int, const char *, mode_t mode);
...
typedef int (*funcptr_stat64)(const char *, struct stat64 *);
...
typedef int (*funcptr_fstat64)(int, struct stat64 *);
typedef int (*funcptr_fstatat)(int dirfd, const char *, struct stat *buf, int flag);
typedef int (*funcptr_fstatat64)(int dirfd, const char *, struct stat64 *buf, int flag);
...
typedef int (*funcptr_readlinkat)(int, const char *, char *, size_t);
