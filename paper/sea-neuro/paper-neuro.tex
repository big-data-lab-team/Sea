...
\TG{Revise the numbers in this paragraph according to current notebook}
...
did not lead to significant differences in average makespan (\TG{p=x, two-sampled T-test}). Given these results, we conclude that the
...
\end{figure*}
  ...
  3.2$\times$, processing 8 ds001545 images.
    ...
    found to be 11$\times$ \TG{Double check this number}.
