...
\begin{subfigure}{0.8\textwidth}
    ...
    \includegraphics[width=\textwidth]{figures/slashbin_nozoom.pdf}%
    \caption{Complete results}\label{fig:seaneuro:slashbinfull}
\end{subfigure}
\begin{subfigure}{0.8\textwidth}
    \centering
    \captionsetup{width=\textwidth}
    \includegraphics[width=\textwidth]{figures/slashbin_withzoom.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.8\textwidth]{figures/beluga_sea_tmpfs.pdf}%
...
\begin{subfigure}{0.8\textwidth}
    ...
    \includegraphics[width=\textwidth]{figures/beluga_withoutflush_nozoom.pdf}%
    \caption{Complete results}\label{fig:seaneuro:belugafull}
\end{subfigure}
\begin{subfigure}{0.8\textwidth}
    \centering
    \captionsetup{width=\linewidth}
    \includegraphics[width=\textwidth]{figures/beluga_withoutflush_zoom.pdf}
...
\begin{subfigure}{0.8\textwidth}
    \centering
    \captionsetup{width=\textwidth}
    \includegraphics[width=\textwidth]{figures/beluga_withflush_zoom.pdf}
